...
export default {
  data() {
    return {
      ...
      menu2: false,
      nom: "",
      genres: ["FPS", "MOBA", "SPORT", "COURSE", "BATTLE ROYAL", "AVENTURE", "EDUCATIF", "SIMULATION", "STRATEGIE", "GESTION", "PLATEFORME"],
      plateforme: ["PC", "PS", "SWITCH", "XBOX"],
      mode: ["SOLO", "MULTIPLAYER", "COOP","SOLO/MULTIPLAYER" ,"SOLO/COOP" ,"SOLO/COOP/MULTIPLAYER"],
      nbVotes: 0,
      nom: "",
      dateSortie: "",
      configuration: "",
