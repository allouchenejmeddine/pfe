            ...
            <v-layout pa-3 column>
              <v-flex>
                <v-layout px-3 pb-3>
                  ...
                  <v-flex><span class="font-weight-thin font-italic caption">Proposé par </span><v-btn depressed flat small fab  :to="{ path: '/user/'+this.redacteurId }" target="_blank">>{{this.redacteur}}</v-btn>
                  </v-flex>
                </v-layout>
