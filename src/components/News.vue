            ...
            <v-layout column ma-3>
              ...
              <v-flex>
                <v-layout row wrap justify-start pa-3>
                    <v-flex md12 xs12 sm12 pa-3 v-for="(item,i) in articlesChargedForALL" :key="i" :src="item">
...
export default {
    ...
    computed :{
        articlesChargedForALL : function (){
            ...
            return all.sort(function(a,b){return a.dateSortie.localeCompare(b.Sortie); });
        }
    }
}
</script>