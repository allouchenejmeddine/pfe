          ...
          <v-list>
            <v-layout column ma-3>
              ...
              <v-layout row wrap justify-start pa-3>
                <v-flex md12 xs12 sm12 pa-3 v-for="(item,i) in articleCharged" :key="i" :src="item">
                  <v-card light raised tile>
                              ...
                              <v-layout>
                                    <v-flex pa-2>
                                        <v-card pa-4 color="rgba(0, 128, 128,0.8)">
                                            <v-card-title><v-layout align-center justify-space-around>{{item.titre}}</v-layout></v-card-title>
                                        </v-card>
                                    </v-flex>
                                </v-layout>
                              </v-img>
                    ...
                    <v-btn flat icon><v-icon color="green" @click="moveToConfirmedArticles(item.id)">fas fa-check</v-icon></v-btn>
